...
def check_response(device, save_path):
    ...
    model_path = str(save_path) + '/' + model_path
    ...
    fig.savefig(str(save_path) + '/model_output.png')


if __name__ == '__main__':

    save_path = '/home/albertestop/Sensorium/data/experiments/train_test_000_17/fold_0'
