...
user_model_list = np.array([1, 2, 3])  # Lista de modelos proporcionada por el usuario
if randomize_models:
...
animals = range(3, 5)  # Solo incluye el índice 4
