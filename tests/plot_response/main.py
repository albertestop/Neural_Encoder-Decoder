...
class Responses_plot:
    ...
    def process(self, video_frame_time=None):
        ...
        _ = self.upscale_data(df)
        print('check')
        print(self.upscaled_time.shape, self.upscaled_data.shape)
        plt.plot(self.upscaled_time[100:380], self.upscaled_data[100:380])
    ...
    def upscale_data(self, df):
        ...
        plt.plot(np.arange(len(df)), np.array(df['responses']))
        plt.savefig()
...
plt.plot(responses.time[session_plot_start:session_plot_end], responses.spikes[0, session_plot_start:session_plot_end], label='Spikes')
...
plt.plot(responses.time[session_plot_start:session_plot_end], responses.dF[0, session_plot_start:session_plot_end], label='dF')
plt.ylabel('Response Amplitude')
plt.xlabel('Time')
plt.title('Response time coherence')
plt.legend()
...
plt.plot(responses.time[session_plot_start:session_plot_end], responses.F[0, session_plot_start:session_plot_end], label='F')
plt.ylabel('Response Amplitude')
plt.xlabel('Time')
plt.title('Response time coherence')
plt.legend()
...
plt.plot(responses.time[session_plot_start:session_plot_end], responses.dF_F[0, session_plot_start:session_plot_end], label='dF/F')
plt.ylabel('Response Amplitude')
plt.xlabel('Time')
plt.title('Response time coherence')
plt.legend()
