...
start_trial = 347  # Se refiere al índice del trial en el fold seleccionado
end_trial = 400  # No incluye este
...
pretrained_mask = 'mask_2025-07-04_04_ESPM154_006.npy'  # not used for movie sessions
...
model_path[0] = Path('/gpfs/projects/uab103/uab020077/Sensorium/data/experiments/train_test_015_6/fold_0/model-017-0.255306.pth').expanduser()
model_path[1] = Path('/gpfs/projects/uab103/uab020077/Sensorium/data/experiments/train_test_015_6/fold_1/model-017-0.308476.pth').expanduser()
model_path[2] = Path('/gpfs/projects/uab103/uab020077/Sensorium/data/experiments/train_test_015_6/fold_2/model-017-0.282842.pth').expanduser()
model_path[3] = Path('/gpfs/projects/uab103/uab020077/Sensorium/data/experiments/train_test_015_6/fold_3/model-017-0.257471.pth').expanduser()
model_path[4] = Path('/gpfs/projects/uab103/uab020077/Sensorium/data/experiments/train_test_015_6/fold_4/model-017-0.267113.pth').expanduser()
model_path[5] = Path('/gpfs/projects/uab103/uab020077/Sensorium/data/experiments/train_test_015_6/fold_5/model-017-0.286439.pth').expanduser()
model_path[6] = Path('/gpfs/projects/uab103/uab020077/Sensorium/data/experiments/train_test_015_6/fold_6/model-017-0.259915.pth').expanduser()
