...
pretrained_mask = 'mask_2025-07-17_01_ESPM154_000.npy'
...
model_path[0] = Path(str(Path.home()) + '/Sensorium/data/experiments/train_test_018/fold_0/model-017-0.157990.pth').expanduser()
