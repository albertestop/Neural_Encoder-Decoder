...
fold_number = 6  # Definir el número de fold
...
mask_name = 'mask_m_dynamic29515_ART_FROM_VIDEO_7.npy'
mask_update_th = 0.5
mask_eval_th = 1
...
model_path[0] = Path('/home/albertestop/Sensorium/data/experiments/train_test_000_18/fold_6/model-017-0.228428.pth').expanduser()
