...
pretrained_mask = 'mask_2025-08-07_01_ESPM163_008.npy'  # not used for movie sessions
...
model_path[0] = Path(str(Path.home()) + '/Sensorium/data/experiments/train_test_018_7/fold_0/model-017-0.093864.pth').expanduser()
model_path[1] = Path(str(Path.home()) + '/Sensorium/data/experiments/train_test_018_2/fold_1/model-017-0.168618.pth').expanduser()
model_path[2] = Path(str(Path.home()) + '/Sensorium/data/experiments/train_test_018_2/fold_2/model-017-0.153529.pth').expanduser()
model_path[3] = Path(str(Path.home()) + '/Sensorium/data/experiments/train_test_018_2/fold_3/model-017-0.164986.pth').expanduser()
model_path[4] = Path(str(Path.home()) + '/Sensorium/data/experiments/train_test_018_2/fold_4/model-017-0.162484.pth').expanduser()
model_path[5] = Path(str(Path.home()) + '/Sensorium/data/experiments/train_test_018_2/fold_5/model-017-0.159401.pth').expanduser()
model_path[6] = Path(str(Path.home()) + '/Sensorium/data/experiments/train_test_018_2/fold_6/model-017-0.144976.pth').expanduser()
