...
model_path[0] = Path(str(Path.home()) + '/Sensorium/data/experiments/train_test_021_1/fold_0/model-017-0.163605.pth').expanduser()
...
model_path[4] = Path(str(Path.home()) + '/Sensorium/data/experiments/train_test_015_3/fold_4/model-017-0.271789.pth').expanduser()
model_path[5] = Path(str(Path.home()) + '/Sensorium/data/experiments/train_test_015_3/fold_5/model-017-0.287657.pth').expanduser()
model_path[6] = Path(str(Path.home()) + '/Sensorium/data/experiments/train_test_015_3/fold_6/model-017-0.259413.pth').expanduser()
