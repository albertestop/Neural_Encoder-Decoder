...
start_trial = 6  # Se refiere al índice del trial en el fold seleccionado
end_trial = 7  # No incluye este
...
model_path[0] = Path('/home/albertestop/Sensorium/data/experiments/train_test_000_17/fold_0/model-013-0.825909.pth').expanduser()
