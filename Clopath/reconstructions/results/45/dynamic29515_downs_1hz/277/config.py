...
start_trial = 22  # Se refiere al índice del trial en el fold seleccionado
end_trial = 23  # No incluye este
...
model_path[0] = Path('/home/albertestop/Sensorium/data/experiments/train_test_000_2/fold_1/model-017-0.141912.pth').expanduser()
