...
start_trial = 4  # Se refiere al índice del trial en el fold seleccionado
end_trial = 5  # No incluye este
...
model_path[0] = Path('/home/albertestop/Sensorium/data/experiments/train_test_000_2/fold_0/model-017-0.130134.pth').expanduser()
