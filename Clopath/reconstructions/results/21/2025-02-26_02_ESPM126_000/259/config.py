...
animals = range(0, 1, 2) # solo incluye el índice 0
...
model_path[0] = Path('/home/albertestop/Sensorium/data/experiments/train_test_010/fold_0/model-017-0.207052.pth').expanduser()
