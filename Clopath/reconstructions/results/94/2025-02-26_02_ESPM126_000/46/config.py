...
start_trial = 1  # Se refiere al índice del trial en el fold seleccionado
end_trial = 2  # No incluye este
...
mask_name = 'mask_2025-02-26_02_ESPM126_000.npy'
mask_update_th = 0.5
mask_eval_th = 1
reconstruct_params = dict(
    subbatch_size = 32,
    minibatch = 8,
    epoch_number_first = 70,
    mask = True,
    n_steps = 1,
    epoch_reducer = 1,
    vid_init = 'gray',
...
model_path[0] = Path('/home/albertestop/Sensorium/data/experiments/train_test_003_3/fold_0/model-017-0.217497.pth').expanduser()
...
model_path[2] = Path('/home/albertestop/Sensorium/data/experiments/train_test_004/fold_1/model-011-0.277022.pth').expanduser()
...
model_path[6] = Path('/home/albertestop/Sensorium/data/experiments/train_test_art/fold_1/model-003-0.444749.pth').expanduser()
