...
user_model_list = np.array([6])  # Lista de modelos proporcionada por el usuario
if randomize_models:
...
start_trial = 11  # Se refiere al índice del trial en el fold seleccionado
end_trial = 12  # No incluye este
