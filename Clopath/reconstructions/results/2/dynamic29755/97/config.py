...
opt_for_pred_responses = False # If set to True, review src/predictors.generate_predictors() We generate the video to match the responses generated by the original video, not the original responses.
mask_update_th = 0.5
mask_eval_th = 1
